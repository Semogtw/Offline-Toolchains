...
- Generated: `2026-08-25T05:51:25.814924Z`
- Enabled providers: **16**
- Exhaustively paginated providers: **11**
- Unique source occurrences: **11043**
- Conservative title-deduplicated works: **9538**
...
| `ptbr.astratoons` | exhausted | 18 | 177 | 177 | 0 | `next_page_token_null` |
...
| `ptbr.mangalivreblog` | failed | 0 | 0 | 0 | 0 | `provider_failure` |
