...
class SanitizedOutputContractTest(unittest.TestCase):
    ...
    def test_workflow_gates_logs_and_outputs_before_upload_or_summary(self) -> None:
        ...
        self.assertIn("GOANIME_YUZONO_CANDIDATE_ARTIFACT", finalizer)
        self.assertIn("test_falsification", finalizer)
        self.assertIn("steps.falsification.outcome == 'success'", finalizer)
