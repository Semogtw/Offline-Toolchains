...
from verify_goanime_toolchain_receipt import verify_receipt
...
def artifact(artifact_id: int, name: str, *, expires: str = "2026-08-04T00:00:00Z") -> dict[str, object]:
    return {
...
class VerifyGoAnimeToolchainReceiptTest(unittest.TestCase):
    ...
    def test_rejects_non_contiguous_parts(self) -> None:
        payload = receipt()
        payload["artifacts"][-1]["name"] = (
            "goanime-flutter-cache-linux-x64-part-02"
        )
